...
<div id="content" class="flex flex-col container gap-3 pt-4 pb-6 px-3 mobile:px-2">
    <div class="flex flex-col gap-4" dir="ltr">
        <h1 class="content-header-title">FUQ</h1>
        <div class="grid desktop:grid-cols-[350px_1fr] gap-8">
            <div class="flex flex-col rounded">
                <a class="logo-container network-logo" href="https://www.fuq.com" title="fuq" target="_blank">
                ...
                <div class="block w-full text-center m-0 text-md filter rounded-b p-2 network-button-container">
                    <a href="https://www.fuq.com" class="button button-secondary w-full h-full" target="_blank">
                        Visit fuq.com NOW!
                    </a>
                </div>
            </div>
            <div class="flex flex-col gap-4">
                <h3 class="m-0 p-0">The Place To Be For The Best Porn Videos</h3>
