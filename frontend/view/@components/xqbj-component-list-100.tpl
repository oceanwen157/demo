...
<div class="cards-container">
    {foreach name="__RECOMMENDVIDEO__" item="e" key="i" }
        <div class="card group">
            <a width="360" height="200" aria-hidden="true" tabindex="-1" class="relative block item-link" href="{$e.category.route_path}" title="{$e.video.title_en} ">
                <img class="item-image" z-image-loader-url="{$e.video.cover_new}" loading="eager"  alt="{$e.video.title_en}"/>
