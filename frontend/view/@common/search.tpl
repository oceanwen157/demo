        ...
        <form name="search_query" method="post" target="_self" class="relative grow">
            <div id="search_query" class="flex justify-center">
                <div class="input-container">
                    <input type="search" name="search_query[query]" id="search_query_query" class="input search_query" placeholder="{$Think.lang.search} 45,673,628 {$Think.lang.videos} ..." aria-label="Search 45,673,628 videos ..." autocomplete="off" maxlength="200" value="" required="">
